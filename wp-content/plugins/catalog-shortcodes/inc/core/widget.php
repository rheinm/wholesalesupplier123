...
class Ts_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			'classname'   => 'catalog',
			'description' => __( 'Catalog Shortcodes widget', 'catalog' )
		);
		$control_ops = array(
			'width'   => 300,
			'height'  => 350,
		...
		parent::__construct( 'catalog', __( 'Catalog Shortcodes', 'catalog' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array(
			'title'   => __( 'Catalog Shortcodes', 'catalog' ),
			'content' => ''
		);
		$instance = wp_parse_args( ( array ) $instance, $defaults );
?>
				<p>
					<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'catalog' ); ?></label>
